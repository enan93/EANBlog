...
namespace BlogProject42020.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //var emailConfirmed = await UserManager.IsEmailConfirmedAsync(userId.Id);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(ExtRegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var email = new MailMessage(from, model.Email)
                {
                    ...
                    Body = $"Please click <a href=\"{callbackUrl}\">here</a> to reset your password.",
                    IsBodyHtml = true
                };
